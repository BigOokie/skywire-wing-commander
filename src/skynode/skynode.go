...
func (ni NodeInfo) String() string {
	return fmt.Sprintf("Key: %s, Type: %s, SendBytes: %v, RecvBytes: %v, LastAckTime: %v, StartTime: $v", ni.Key, ni.Conntype, ni.SendBytes, ni.RecvBytes, ni.LastAckTime, ni.StartTime)
}
